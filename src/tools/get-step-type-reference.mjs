...
<cc:async-mediation id="Async2" routes-to="NextStep">
  ...
  'splitter': {
    description: 'Splits an XML document into multiple messages based on an XPath expression. Each sub-message is processed independently via cc:sub-route.',
    routes_via: 'routes-to (on sub-route)',
    xml_example: `<cc:splitter id="SplitByEmployee" no-split-message-error="false">
  <cc:sub-route name="SubRoute" routes-to="ProcessEmployee"/>
  <cc:xpath-splitter xpath="wd:Report_Data/wd:Report_Entry"/>
</cc:splitter>`,
  },
  'decision': {
